...
@connect((store) => {
  ...
  return {fetching: forgotPasswordStore.fetching, success: forgotPasswordStore.success, error: forgotPasswordStore.error};
})
class ForgotPassword extends Component {
  ...
  handleReset(e) {
    e.preventDefault();
    this.props.dispatch(actions.requestForgotPasswordLink({email: this.state.email}));
  }
